...
/* harmony import */ var _components_loading__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/loading */ "./src/js/components/loading.js");
/* harmony import */ var _components_loading__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_loading__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_language__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/language */ "./src/js/components/language.js");
...
/* harmony import */ var _components_banner__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/banner */ "./src/js/components/banner.js");
/* harmony import */ var _components_banner__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_banner__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_btn_star_flow__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/btn-star-flow */ "./src/js/components/btn-star-flow.js");
/* harmony import */ var _components_btn_star_flow__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_btn_star_flow__WEBPACK_IMPORTED_MODULE_5__);
...
/***/ "./src/js/components/btn-star-flow.js":
/*!********************************************!*\
  !*** ./src/js/components/btn-star-flow.js ***!
  \********************************************/
/***/ (() => {
...
const savedLanguage = js_cookie__WEBPACK_IMPORTED_MODULE_2__["default"].get('i18nextLng') || 'ru';
i18next__WEBPACK_IMPORTED_MODULE_0__["default"].use(i18next_http_backend__WEBPACK_IMPORTED_MODULE_1__["default"]).init({
  lng: savedLanguage,
  backend: {
...
function translateElement(element) {
  ...
  if (element.tagName.toLowerCase() === 'input') {
    element.placeholder = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t(key);
  } else {
    element.innerHTML = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t(key);
  }
}
function translateDate(element) {
  ...
  if (dateString) {
    ...
    const formattedDate = new Intl.DateTimeFormat(i18next__WEBPACK_IMPORTED_MODULE_0__["default"].language, {
      year: undefined,
      month: 'long',
      day: 'numeric',
      hour: '2-digit',
...
function updateLanguageSwitch() {
  const currentLanguage = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].language;
...
switchElements?.forEach(switchElement => {
  switchElement.addEventListener('click', function () {
    ...
    if (switchType === 'toggle') {
      const newLang = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].language === 'ru' ? 'en' : 'ru';
      i18next__WEBPACK_IMPORTED_MODULE_0__["default"].changeLanguage(newLang, function () {
        js_cookie__WEBPACK_IMPORTED_MODULE_2__["default"].set('i18nextLng', newLang, {
          expires: 365
        });
        updateContent();
        updateLanguageSwitch();
      ...
      radios.forEach(function (radio) {
        radio.addEventListener('change', function () {
          ...
          i18next__WEBPACK_IMPORTED_MODULE_0__["default"].changeLanguage(selectedLanguage, function () {
            js_cookie__WEBPACK_IMPORTED_MODULE_2__["default"].set('i18nextLng', selectedLanguage, {
              expires: 365
            });
            updateContent();
            updateLanguageSwitch();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const savedTheme = js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].get('theme');
